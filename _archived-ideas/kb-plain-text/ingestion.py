...
# Chunking configuration - optimized for KB articles
CHUNK_SIZE = 1500      # Larger chunks provide more context for KB how-to content
CHUNK_OVERLAP = 150    # ~10% overlap to maintain context continuity
