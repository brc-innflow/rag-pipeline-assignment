...
RAG Pipeline - Generation Module (HTML Header-Based)
Uses retrieved context to generate answers using OpenAI LLM.
Includes header hierarchy information in sources for better traceability.
"""
...
from retrieval import retrieve_chunks, format_retrieved_context
...
def interactive_mode():
    ...
    print("\n" + "=" * 60)
    print("RAG Pipeline - Interactive Q&A (HTML Header-Based)")
    ...
    while True:
        ...
        try:
            ...
            for source in result["sources"]:
                # Create unique key from title + section
...
def main():
    ...
    print("=" * 50)
    print("RAG Pipeline - Generation (HTML Header-Based)")
    print("=" * 50)
