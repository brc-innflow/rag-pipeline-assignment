...
Metadata-Filtered RAG - Precision Delta Evaluation (HTML Header-Based)
...
for category-specific, subtopic-specific, or header-specific questions.
...
# Adjust categories/subtopics/headers based on your actual KB content
...
def run_evaluation(
    ...
    print("=" * 60)
    print("Metadata-Filtered RAG - Precision Delta Evaluation (HTML)")
    print("=" * 60)
    print(f"\nConfiguration:")
